...
const Map<String, List<String>> preventiveSeedMap = {
  'GP': [
...
Future<void> seedPreventive(Box<Preventive> box) async {
  if (box.isNotEmpty) return;
  await box.addAll(
    preventiveSeedMap.entries
        .expand((entry) => entry.value
            .map((codigo) => Preventive(setor: entry.key, codigo: codigo)))
        .toList(),
  );
}